...
Usage: .\task-cli add "task description"`,
...
Usage: .\task-cli update <id> "new description"`,
...
Usage: .\task-cli updateInProgress <id>`,
	Args: cobra.MaximumNArgs(1),
